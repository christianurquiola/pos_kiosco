                    ...
                    <form action="{{ route('dashboard.products.update', $product->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        @foreach (config('laravellocalization.supportedLocales') as $locale => $v)
                            <div class="form-group">
                                ...
                                <input type="text" name="name_{{ $locale }}" class="form-control" value="{{ $product->getTranslation('name',$locale) }}" required="required">
                                @error("name_{{ $locale }}")
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description_{{ $locale }}" class="form-control ckeditor">{!! $product->getTranslation('description',$locale) !!}</textarea>
                            </div>
                        @endforeach
